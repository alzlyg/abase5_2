...
/*
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.clickOnImage();//onFragmentInteraction(uri);
        }
    }
*/
    @Override
    ...
    public void changeTemperature(String city, int temperature) {
        textView.setText("Погода в городе " + city +": " + temperature);
    }
